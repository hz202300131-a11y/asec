...
const AddClientType = ({ setShowAddModal, onSuccess }) => {
  ...
  const handleSubmit = (e) => {
    ...
    post(route('client-type-management.store'), {
      onSuccess: () => {
  ...
  return (
    <Dialog open onOpenChange={setShowAddModal}>
      <DialogContent className="w-[95vw] max-w-[600px]">
        <DialogHeader>
          <DialogTitle className="text-zinc-800">Add Client Type</DialogTitle>
          <DialogDescription className="text-zinc-600">
            Enter the details for the new client type below.
          </DialogDescription>
        </DialogHeader>
