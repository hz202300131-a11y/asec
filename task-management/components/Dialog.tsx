...
export default function Dialog({
  ...
  const getIcon = () => {
    switch (type) {
      case 'success':
        return <CheckCircle2 size={32} color={AppColors.success || '#10b981'} />;
      case 'error':
        return <AlertCircle size={32} color={AppColors.error || '#ef4444'} />;
      case 'warning':
        return <AlertCircle size={32} color={AppColors.warning || '#f59e0b'} />;
      case 'confirm':
  ...
  const getIconColor = () => {
    switch (type) {
      case 'success':
        return AppColors.success || '#10b981';
      case 'error':
